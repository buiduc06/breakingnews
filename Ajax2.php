...
<img class=entry-thumb src="image/tintuc/<?= $VanHoa11->Hinh ?>" style="width: 218px;height: 150px" alt="" title="<?= $VanHoa11->TieuDe ?>" /></a></div>

<div class=item-details>
<h3 class="entry-title td-module-title">
<a href="td-post-apple-tv-is-finally-changing-the-living-room/index.html" rel=bookmark title="<?= $VanHoa11->TieuDe ?>"><?= $VanHoa11->TieuDe ?></a></h3>
