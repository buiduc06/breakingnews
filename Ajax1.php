...
<div class=td-module-thumb><a href="td-post-sanders-gets-respectful-welcome-at-conservative-college/index.html" rel=bookmark title="<?=  $getBody71->TieuDe ?>"><img width=324 height=160 class=entry-thumb src="image/tintuc/<?=  $getBody71->Hinh ?>" alt="" title="<?=  $getBody71->TieuDe ?>" /></a>
...
<span class=td-post-author-name><a href="author/admin/index.html"><?=  $getBody71->getTacGia2()->name ?></a> <span>-</span> </span> <span class=td-post-date><time class="entry-date updated td-module-date" datetime="2015-09-16T08:57:18+00:00">September 16, 2015</time></span> 
...
<a href="td-post-the-secret-to-your-companys-financial-health/index.html" rel=bookmark title="The Secret to Your Company&#8217;s Financial Health"><img class=entry-thumb src="image/tintuc/<?= $getBody2->Hinh ?>" style="width: 100px;height: 70px;" alt="" title="<?=  $getBody2->TieuDe ?>" /></a></div>
